...
![](https://img.shields.io/badge/LAST_UPDATE-2023--04--12-blue)
...
| 버전  | 구현 기간               | 기능                                                   |
|:----|:--------------------|:-----------------------------------------------------|
| 5.0 | 23-04-12 ~          | 게시글 권한 부여                                            |
| 4.0 | 23-04-10 ~ 23-04-12 | 로그인, 로그아웃 기능                                         |
...
- 게시글 권한 부여
  - 게시글 작성 기능
    - [ ] 게시글에서 글쓴이 입력 필드 삭제
    - [ ] 게시글 글쓴이 필드를 User의 name 값으로 변경
    - [ ] 로그인하지 않은 사용자가 게시글 작성 페이지에 접근할 시 로그인 페이지로 이동하는 기능
  - 게시글 수정 기능
    - [ ] 로그인 사용자와 글쓴이의 사용자 아이디가 같은 경우, 게시글 수정하는 기능 활성화
  - 게시글 삭제 기능
