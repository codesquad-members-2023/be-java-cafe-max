![](https://img.shields.io/badge/VERSION-6.1-green)
![](https://img.shields.io/badge/LAST_UPDATE-2023--04--28-blue)
...
- 미션 기간(max 4~7주차): `
  ...
  - 6단계: `23-04-17 ~ 23-04-21` [5d]
  - 리팩토링: `23-04-24 ~ 23-04-28` [5d]
...
| 버전  | 구현 기간               | 기능                                                   |
|:----|:--------------------|:-----------------------------------------------------|
| 6.1 | 23-04-24 ~ 23-04-28 | 게시글 댓글 표시 기능, 게시글 삭제 기능 추가                           |
...
- 게시글 권한 부여
  ...
  - 게시글 수정 기능
    ...
    - [X] 로그인 사용자와 글쓴이의 사용자 아이디가 불잁치할 경우, 에러 페이지 출력 혹은 버튼 비활성화
  - 게시글 삭제 기능
    - [X] 로그인 사용자와 글쓴이의 사용자의 아이디가 같은 경우, 게시글 삭제 기능 활성화
    - [X] 로그인 사용자와 글쓴이의 사용자 아이디가 불잁치할 경우, 에러 페이지 출력 혹은 버튼 비활성화
...
| 게시글 삭제        | /articles/{articleId}   | qna/show.html      | `DELETE` |
...
- [X] Article sequence 필드명을 index와 혼용 중인 코드 통일
