...
public enum UserDuplicatedExceptionType implements BaseExceptionType {
    ...
    UserDuplicatedExceptionType(int errorCode, HttpStatus httpStatus, String errorMessage) {
