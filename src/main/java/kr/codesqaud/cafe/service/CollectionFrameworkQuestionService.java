...
import kr.codesqaud.cafe.repository.CollectionFrameWorkQuestionRepository;

@Service
public class CollectionFrameworkQuestionService implements QuestionService {
	private final CollectionFrameWorkQuestionRepository repository;

	public CollectionFrameworkQuestionService(CollectionFrameWorkQuestionRepository repository) {
