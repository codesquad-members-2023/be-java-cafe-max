...
public class JdbcTemplateReplyRepository implements ReplyRepository {
    ...
    public Long save(Reply reply) {
        String sql = "insert into " + Tables.REPLIES + " (article_id, user_id, reply_content, reply_time, deleted) " +
    ...
    public Optional<Reply> findById(Long id) {
        String sql = "select id, article_id, user_id, reply_content, reply_time from " + Tables.REPLIES + " where id = :id and deleted=false";
    ...
    public List<Reply> findByArticleId(Long articleId) {
        ...
        String sql = "select r.id, r.user_id, r.article_id, u.user_id, r.reply_content, r.reply_time " +
                "from " + Tables.REPLIES + " r join " + Tables.USERS + " u on r.user_id = u.user_id " +
    ...
    public void deleteReply(Long id) {
        String articleDeletedSql = "update " + Tables.REPLIES + " set deleted=true where id=:id";
