...
// 	@BeforeEach
// 	void setup() {
// 		articlePostRequest = new ArticlePostRequest("제목입니다", "내용입니다", 1l, "2023-4-15");
...
//
// 		// Then
// 		Assertions.assertThat(articleMapper.toArticle(articlePostRequest).equals(article)).isTrue();
// 	}
//
// 	@Test
